...
public class PersonalDetailsPanel extends JPanel {
    ...
    { //Adapted from: https://www.geeksforgeeks.org/java-swing-simple-user-registration-form/
        ...
        admininput.setLocation(260, 160);
        add(admininput);
        ...
        tdoctorname.setLocation(210, 230);
        add(tdoctorname);
        ...
        tdoctoremail.setLocation(210, 250);
        add(tdoctoremail);
        ...
        tdoctorphone.setLocation(210, 270);
        add(tdoctorphone);
